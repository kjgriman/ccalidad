...
if(isset($_POST['btn-aceptar']))
{
   ...
   $nro = $ficha->registeritem($idcategory,$name_item);
  // echo "Nro ".$nro;
...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    <strong><?php echo $msje; ?></strong>
            ...
            <?php    }
                ?>
              <h3 class="box-title">Ingreso de Categoria</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			<div class="row">
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="id_category" required="required" class="form-control select2" style="width: 100%;" required>
                	
                  	<?php 
                  	$categoryarea = $ficha->getAllCategoriasjouinarea();
                  	foreach ($categoryarea as $ke4 => $value4) {
                  			?>

                  	<option value="<?php echo $categoryarea[$ke4]['id']?>"><?php echo $categoryarea[$ke4]['nombre'].' | '.  $categoryarea[$ke4]['name_area'] ?></option>
                  			<?php
                  		}	
                  	?>
                  </select>
