          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?php print($userRow['user_name'] .' | '. $userRow['id_area']); ?>
                </p>
              </li>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Inspecciones satisfactorias</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Amonestaciones de la semana</p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#revenue-chart" data-toggle="tab">Resultados</a></li>
              <li class="pull-left header"><i class="fa fa-inbox"></i> Inspeciones</li>
            </ul>
