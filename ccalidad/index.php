 ...
 if(isset($_GET['newuser']))
            {
                 ...
                 <div class="alert alert-info">
                      <i class="glyphicon glyphicon-log-in"></i> &nbsp; Ya puedes ingresar con el usuario creado
                 </div>
                 <?php
            }
?>
...
<center><img src="http://danielzawadzki.com/codepen/01/icon.svg" id="icon" alt="User Icon" /></center><br>
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="btn-login" class="btn btn-primary btn-block btn-flat" id="load" data-loading-text="Validando...">Ingresar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="olvido_passwd.php"><i class="fa fa-lock"></i> Olvidé mi contraseña</a><br>

  </div>
<div class="min-footer"><div class="col-left"><a href="reg_user.php"><i class="fa fa-user"></i> Crear un cuenta</a><br><br>
